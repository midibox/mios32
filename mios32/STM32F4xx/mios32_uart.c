...
#define MIOS32_UART0_TX_PIN      GPIO_Pin_6
#define MIOS32_UART0_RX_PORT     GPIOB
#define MIOS32_UART0_RX_PIN      GPIO_Pin_7
...
#define MIOS32_UART0_REMAP_FUNC  { GPIO_PinAFConfig(GPIOB, GPIO_PinSource6, GPIO_AF_USART1); GPIO_PinAFConfig(GPIOB, GPIO_PinSource7, GPIO_AF_USART1); }
