...
void APP_Background(void)
{
  ...
  s8 mios_b = 0;
  s8 dir = 1;
  s8 knob_icon_ctr[4] = {0, 3, 6, 9}; // memo: 12 icons
  s8 knob_icon_delay_ctr[4] = {0, 2, 4, 6};
  const s8 knob_icon_x[4] = {0, 100, 0, 100}; // memo: icon width 28
  const s8 knob_icon_y[4] = {0, 0, 104, 104}; // memo: icon height 32

  s8 vmeter_icon_ctr[2] = {0, 5}; // memo: 28 icons (14 used)
  s8 vmeter_icon_dir[2] = {1, 1};
  s8 vmeter_icon_delay_ctr[2] = {1, 4};
  const s8 vmeter_icon_x[2] = {0, 120}; // memo: icon width 8
  const s8 vmeter_icon_y[2] = {48, 48}; // memo: icon height 32

  s8 hmeter_icon_ctr[2] = {6, 11}; // memo: 28 icons (14 used)
  s8 hmeter_icon_dir[2] = {1, 0};
  s8 hmeter_icon_delay_ctr[2] = {4, 2};
  const s8 hmeter_icon_x[2] = {50, 50}; // memo: icon width 28
  const s8 hmeter_icon_y[2] = {0, 120}; // memo: icon height 8
  ...
  while( 1 ) {
    ...
    MIOS32_LCD_FontInit(GLCD_FONT_KNOB_ICONS); // memo: 12 icons, icon size: 28x24
    for(i=0; i<4; ++i) {
    ...
    // print vmeter icons
    MIOS32_LCD_FontInit(GLCD_FONT_METER_ICONS_V); // memo: 28 icons, 14 used, icon size: 8x32
    for(i=0; i<2; ++i) {
    ...
    // print hmeter icons
    MIOS32_LCD_FontInit(GLCD_FONT_METER_ICONS_H); // memo: 28 icons, 14 used, icon size: 28x8
    for(i=0; i<2; ++i) {
