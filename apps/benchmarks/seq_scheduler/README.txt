...
0: internal static allocation with one byte for each flag     627.2 mS
1: internal static allocation with 8bit flags                 635.4 mS
2: internal static allocation with 16bit flags                634.3 mS
3: internal static allocation with 32bit flags                627.2 mS
4: FreeRTOS based pvPortMalloc                                609.3 mS
...
memory, method 4 could result into worse performance or non-deterministic
behaviour once a garbage collection is added, or once different tasks are 
