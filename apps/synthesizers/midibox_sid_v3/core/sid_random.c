...
u32 SID_RANDOM_Gen(u32 seed)
{
  ...
  // MEMO: for thread safeness, we would have to pass a pointer to random_value through the SID_RANDOM_Gen() function
...
/////////////////////////////////////////////////////////////////////////////
u32 SID_RANDOM_Gen_Range(u32 min, u32 max)
{
