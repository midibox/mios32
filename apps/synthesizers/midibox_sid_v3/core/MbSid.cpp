...
void MbSid::midiReceiveCC(u8 chn, u8 cc_number, u8 value)
{
    ...
    if( chn == MbSidSe::sid_se_voice[0].mv->midi_channel ) {
        switch( cc_number ) {
...
/////////////////////////////////////////////////////////////////////////////
void MbSid::SID_MIDI_ArpNoteOn(sid_se_voice_t *v, u8 note, u8 velocity)
{
    sid_se_midi_voice_t *mv = (sid_se_midi_voice_t *)v->mv;
    sid_se_voice_arp_mode_t arp_mode;
    arp_mode.ALL = v->voice_patch->arp_mode;
...
void MbSid::SID_MIDI_ArpNoteOff(sid_se_voice_t *v, u8 note)
{
    sid_se_midi_voice_t *mv = (sid_se_midi_voice_t *)v->mv;
    sid_se_voice_arp_mode_t arp_mode;
    arp_mode.ALL = v->voice_patch->arp_mode;
...
/////////////////////////////////////////////////////////////////////////////
void MbSid::SID_MIDI_NoteOn(sid_se_voice_t *v, u8 note, u8 velocity, sid_se_v_flags_t v_flags)
{
    sid_se_midi_voice_t *mv = (sid_se_midi_voice_t *)v->mv;
...
bool MbSid::SID_MIDI_NoteOff(sid_se_voice_t *v, u8 note, u8 last_first_note, sid_se_v_flags_t v_flags)
{
    sid_se_midi_voice_t *mv = (sid_se_midi_voice_t *)v->mv;
...
// Gate Handling
/////////////////////////////////////////////////////////////////////////////
void MbSid::SID_MIDI_GateOn(sid_se_voice_t *v)
{
    v->state.VOICE_ACTIVE = 1;
...
void MbSid::SID_MIDI_GateOff_SingleVoice(sid_se_voice_t *v)
{
...
void MbSid::SID_MIDI_GateOff(sid_se_voice_t *v, sid_se_midi_voice_t *mv, u8 note)
{
    if( v->engine == SID_SE_MULTI ) {
        ...
        sid_se_voice_t *v_i = (sid_se_voice_t *)&sid_se_voice[0];
        int voice;
