...
public:
    ...
    */
    EditorComponent (AudioProcessing* const ownerFilter);
...
private:
    ...
    // handy wrapper method to avoid having to cast the filter to a AudioProcessing
    // every time we need it..
    AudioProcessing* getFilter() const throw()       { return (AudioProcessing*) getAudioProcessor(); }
};
