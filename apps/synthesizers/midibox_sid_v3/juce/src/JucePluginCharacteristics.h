...
// for MacOS - disable obsolete Carbon UI
...
*/
#define JucePlugin_Name                     "MIDIbox SID Plugin"

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "MIDIbox SID Emulation"

/** The name of your company. (Try to keep this as short as possible)
*/
#define JucePlugin_Manufacturer             "midibox.org"

/** A four-character code for your company.
    Use single quotes - this isn't a string!
*/
#define JucePlugin_ManufacturerCode         MIDIboxSID_COMP_MANF
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               MIDIboxSID_COMP_SUBTYPE
...
/** A version number
*/
#define JucePlugin_VersionCode              kMIDIboxSIDVersion
...
*/
#define JucePlugin_CFBundleIdentifier       "org.midibox.MIDIboxSIDAU"
