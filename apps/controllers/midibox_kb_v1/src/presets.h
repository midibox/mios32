...
#define PRESETS_ADDR_KB1_VELOCITY      (0xc4 + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xc4
#define PRESETS_ADDR_KB1_DOUT_SR1      (0xc5 + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xc5
#define PRESETS_ADDR_KB1_DOUT_SR2      (0xc6 + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xc6
#define PRESETS_ADDR_KB1_DIN_SR1       (0xc7 + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xc7
#define PRESETS_ADDR_KB1_DIN_SR2       (0xc8 + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xc8
#define PRESETS_ADDR_KB1_INVERTED      (0xc9 + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xc9
#define PRESETS_ADDR_KB1_DELAY_FASTEST (0xca + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xca
#define PRESETS_ADDR_KB1_DELAY_SLOWEST (0xcb + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xcb
...
#define PRESETS_ADDR_KB2_VELOCITY      (0xc4 + 1*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xe4
#define PRESETS_ADDR_KB2_DOUT_SR1      (0xc5 + 1*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xe5
#define PRESETS_ADDR_KB2_DOUT_SR2      (0xc6 + 1*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xe6
#define PRESETS_ADDR_KB2_DIN_SR1       (0xc7 + 1*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xe7
#define PRESETS_ADDR_KB2_DIN_SR2       (0xc8 + 1*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xe8
#define PRESETS_ADDR_KB2_INVERTED      (0xc9 + 1*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xe9
#define PRESETS_ADDR_KB2_DELAY_FASTEST (0xca + 1*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xea
#define PRESETS_ADDR_KB2_DELAY_SLOWEST (0xcb + 1*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xeb
