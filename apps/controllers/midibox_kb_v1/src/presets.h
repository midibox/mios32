...
#define PRESETS_ADDR_KB1_AIN_ASSIGN     (0xcb + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xcb
#define PRESETS_ADDR_KB1_CTRL_ASSIGN    (0xcc + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xcc
...
#define PRESETS_ADDR_KB2_AIN_ASSIGN     (0xcb + 1*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xeb
#define PRESETS_ADDR_KB2_CTRL_ASSIGN    (0xcc + 1*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xec
