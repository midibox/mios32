...
writing nonsense data (generated with sector offset) to a sector, read it again and check if
...
this will cause the check to take a very long time. 
When the check is done, the application will report the lower and upper R/W sector, and
