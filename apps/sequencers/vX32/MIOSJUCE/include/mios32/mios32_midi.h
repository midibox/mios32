// $Id: mios32_midi.h 369 2009-02-26 21:01:50Z tk $
/*
...
typedef union {
  ...
  struct {
    union {
      unsigned cin_cable:8; // 0
      struct {
        union {
          unsigned type:4; // 0 0
          unsigned cin:4; // 0 0
        };
        unsigned cable:4; // 0 1
      };
    };
    ...
    union {
      unsigned evnt0:8; // 1
      struct {
        mios32_midi_chn_t chn:4; // 1 0
        mios32_midi_event_t event:4; // 1 1
      };
    };
    ...
    union {
      ...
      unsigned value1:8; // 2
      unsigned note:8; // 2
      unsigned cc_number:8; // 2
      unsigned program_change:8; // 2
    };
    
    union {
      unsigned evnt2:8; // 3
      unsigned value2:8; // 3
      unsigned velocity:8; // 3
      unsigned value:8; // 3
      unsigned dummy:8; // 3
    };
