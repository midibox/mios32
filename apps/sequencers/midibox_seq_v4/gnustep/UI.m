// $Id: UI.m 249 2009-01-06 13:08:34Z tk $
//
//  UI.m
//  midibox_seq_v4
//
...
#if 0 // DO NOT ENABLE THIS (CAUSES MANY MANY EVENTS)
	NSLog(@"MIOS32: PeriodicSRIOTask Started\n");
#endif
...
- (void)periodicMIDITask:(id)anObject
{
	...
	NSLock *theLock = [[NSLock alloc] init];
#if 1
	NSLog(@"MIOS32: Periodic1MidiTask Started\n");
#endif
...
#if 1
	NSLog(@"MIOS32: Periodic1mSTask Started\n");
#endif
...
s32 TASKS_Init(u32 mode)
{
	...
	// install SRIO task
	NSTimer *timer1 = [NSTimer timerWithTimeInterval:0.0001 target:_self selector:@selector(periodicSRIOTask:) userInfo:nil repeats:YES];
	[[NSRunLoop currentRunLoop] addTimer: timer1 forMode: NSEventTrackingRunLoopMode];	
