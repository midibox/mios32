...
static s32 LED_Handler(u16 *gp_leds)
{
  ...
  switch( ui_selected_item ) {
    ...
    case ITEM_HUMANIZE_VALUE: *gp_leds = 0x0300; break;
    case ITEM_HUMANIZE_NOTE: *gp_leds = 0x0c00; break;
    case ITEM_HUMANIZE_VELOCITY: *gp_leds = 0x3000; break;
    case ITEM_HUMANIZE_LENGTH: *gp_leds = 0xc000; break;
  }
...
static s32 LCD_Handler(u8 high_prio)
{
  ...
  SEQ_LCD_PrintString("Trk.  Groove Style  Intensity           RndIntensity  Note   Vel./CC    Length  ");
