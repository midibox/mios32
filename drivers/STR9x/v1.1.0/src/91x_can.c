...
#define EXT_RANGE_ID_MSK_H(range_start, range_end)	\
                                ...
                                ((RANGE_ID_MSK((range_start), (range_end)) >> 27) & 0x03)))
...
#define EXT_RANGE_ID_ARB_H(range_start, range_end)	\
                                ...
                                ((RANGE_ID_ARB((range_start), (range_end)) >> 27) & 0x03)))

#define EXT_FIXED_ID_MSK_L(id)	((u16)(FIXED_ID_MSK(id) >> 11))
#define EXT_FIXED_ID_MSK_H(id)	((u16)(STD_FIXED_ID_MSK(id) | \
                                ((FIXED_ID_MSK(id) >> 27) & 0x03)))
#define EXT_FIXED_ID_ARB_L(id)	((u16)(FIXED_ID_ARB(id) >> 11))
#define EXT_FIXED_ID_ARB_H(id)	((u16)(STD_FIXED_ID_ARB(id) | \
...
u16 CanTimings[] = {        /* value   bitrate     NTQ  TSEG1  TSEG2  SJW  BRP */
  CAN_TIMING(6, 8, 2, 32),  /* 0x755F  100 kbit/s                              @48MHz */
...
//
  CAN->sMsgObj[msg_if].MCR = CAN_MCR_EOB;
...
//    CAN->sMsgObj[0].A1R = EXT_FIXED_ID_ARB_L(pCanMsg->Id);
    CAN->sMsgObj[0].A1R = (u16)pCanMsg->Id;
//    CAN->sMsgObj[0].A2R = (CAN->sMsgObj[0].A2R & 0xE000) | EXT_FIXED_ID_ARB_H(pCanMsg->Id);
    CAN->sMsgObj[0].A2R = (CAN->sMsgObj[0].A2R & 0xE000) | (u16)((pCanMsg->Id)>>16);
  }
...
//    pCanMsg->Id  = (CAN->sMsgObj[1].A2R & 0x1FFF)>>2; 
//    pCanMsg->Id |= (u32)((CAN->sMsgObj[1].A1R))<<11;
    pCanMsg->Id  = ((CAN->sMsgObj[1].A2R) & 0x1FFF)<<16; 
    pCanMsg->Id |= ((u32)CAN->sMsgObj[1].A1R);
